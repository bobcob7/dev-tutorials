---
title: "Asteroid Dodger: Collision Detection"
description: "Add AABB and polygon collision detection, an HP bar with invincibility frames, and a complete game over loop to your Rust asteroid dodger."
difficulty: intermediate
topics: ["Rust", "macroquad", "game dev", "collision detection"]
...
This stops clipping. The ship doesn't yet bounce away — that comes in the [Physics tutorial](/tutorials/rust-macroquad-physics).
...
- **[Unit Testing](/tutorials/rust-macroquad-unit-testing)** — test collision helpers and game logic with `#[cfg(test)]`
- **[Shooting and Destruction](/tutorials/rust-macroquad-shooting-destruction)** — add bullets, hit detection, and asteroid splitting
