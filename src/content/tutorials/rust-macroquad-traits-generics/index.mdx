...
- **[Add a Menu and Shop](/tutorials/rust-macroquad-menu-shop)** — between-rounds upgrades and a shop interface
- **[Add Power-ups and a Shop](/tutorials/rust-macroquad-menu-shop)** — weapon upgrades, bomb refills, shields
