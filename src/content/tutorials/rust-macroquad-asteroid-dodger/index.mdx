...
<div className="callout callout-tip">
  ...
  <p>
    ...
    <a href="/tutorials/rust-macroquad-collision-detection">next tutorial</a>.
  </p>
</div>
...
- **[Collision Detection](/tutorials/rust-macroquad-collision-detection)** — AABB broad phase, polygon-circle narrow phase, HP bar, game over and restart
