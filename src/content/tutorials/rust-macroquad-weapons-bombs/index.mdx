...
This tutorial picks up where the [menu and settings tutorial](/tutorials/rust-macroquad-menu-settings) left off. The ship has one fire mode — a single stream of bullets. This tutorial adds three more weapon types and a deployable bomb, giving the player tactical choices.
...
- Completed the [menu and settings tutorial](/tutorials/rust-macroquad-menu-settings)
- Project compiles and runs with sound, particles, spatial grid, and menu
...
- **[Add Power-ups and a Shop](/tutorials/rust-macroquad-powerups-shop)** — weapon upgrades, bomb refills, shields, and a between-rounds shop
