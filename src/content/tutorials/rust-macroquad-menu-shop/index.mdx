---
title: "Asteroid Dodger: Menu, Power-ups, and Shop"
description: "Add a title screen, rebindable controls, collectible power-ups, and a between-rounds shop to your Rust asteroid dodger."
difficulty: intermediate
topics: ["Rust", "macroquad", "game dev", "UI", "gameplay"]
publishDate: 2026-04-12
---

This tutorial picks up where the [traits and generics tutorial](/tutorials/rust-macroquad-traits-generics) left off. The game has solid mechanics — asteroids collide, split, and explode — but there is no title screen, no way to change controls, and destroying asteroids yields nothing but particle effects. This tutorial adds gameplay progression and UI: collectible power-ups that drop from destroyed asteroids, a main menu with settings, rebindable keybindings, a between-rounds shop, and high score tracking.

## What you'll add

- Power-ups that drop from destroyed asteroids (weapon upgrade, bomb refill, shield, score boost)
- Main menu with play, settings, and exit
- Rebindable keybindings and a volume slider
- Between-rounds shop that opens every 45 seconds, offering permanent upgrades
...
<div className="steps-grid">
  ...
  <div className="step-card">
    ...
    <span className="step-desc">Title screen, game over, restart flow</span>
  </div>
  <div className="step-card">
...
- Project compiles and runs with weapons, bombs, sound, particles, spatial grid, and trait-based collision

---

## Milestone 1 — Power-ups

<span className="step-badge">Milestone 1 of 5</span>
...
<span className="step-badge">Milestone 2 of 5</span>
...
<span className="step-badge">Milestone 3 of 5</span>
...
<span className="step-badge">Milestone 4 of 5</span>
...
<span className="step-badge">Milestone 5 of 5</span>
...
- **[Integration Testing](/tutorials/rust-macroquad-integration-testing)** — add automated tests to verify game logic without running the full graphics loop
- **[Large Map and Minimap](/tutorials/rust-macroquad-large-map)** — camera system, world-space rendering, spatial grid for a larger play area, and a radar display
