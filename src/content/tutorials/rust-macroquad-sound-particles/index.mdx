...
- Completed the [collisions and physics tutorial](/tutorials/rust-macroquad-collisions-physics)
...
**`collision.rs`**, **`player.rs`**, **`asteroid.rs`**, and **`bullet.rs`** are unchanged from the [collisions and physics tutorial](/tutorials/rust-macroquad-collisions-physics).
...
- **[Add a Menu, Settings, and Spatial Grid](/tutorials/rust-macroquad-menu-settings)** — title screen, keybinding editor, high score tracking, and spatial partitioning for collision performance
